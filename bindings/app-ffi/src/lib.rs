...
//!
//! `travel-core` deliberately exposes platform-neutral domain models. This crate is
...
bluetooth::uniffi_reexport_scaffolding!();
call_system::uniffi_reexport_scaffolding!();
location::uniffi_reexport_scaffolding!();
notifications::uniffi_reexport_scaffolding!();
peer_transport::uniffi_reexport_scaffolding!();
ranging::uniffi_reexport_scaffolding!();
secure_storage::uniffi_reexport_scaffolding!();
...
use travel_core::{AppCommand, CoreConfig, TravelCore};
...
fn adapt_snapshot(
    snapshot: travel_core::AppSnapshot,
    revision: u64,
    resources: &BTreeMap<String, LocalResource>,
    now_ms: i64,
