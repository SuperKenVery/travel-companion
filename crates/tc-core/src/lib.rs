...
const STATE_KEY: &str = "tc-core/v1";
...
pub enum CoreError {
    ...
    Call(#[from] tc_call::CallError),
    #[error("peer protocol failed: {0}")]
    Protocol(#[from] tc_protocol::ProtocolError),
...
impl TravelCore {
    ...
    fn materialize_event(&mut self, event: &tc_model::EventEnvelope) -> Result<(), CoreError> {
