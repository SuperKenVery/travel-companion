...
Core Location implementation of the typed `tc-location` contract. Each command is a public method;
events use `TcLocationEvent`, `TcLocationAuthorization`, and `TcLocationSample`. No Core Location
