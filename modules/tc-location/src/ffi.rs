...
impl From<LocationSampleRecord> for tc_model::LocationSample {
...
impl From<tc_model::LocationSample> for LocationSampleRecord {
    fn from(sample: tc_model::LocationSample) -> Self {
        Self {
            latitude: sample.latitude,
            longitude: sample.longitude,
            altitude_m: sample.altitude_m,
