...
Nearby Interaction implementation of the typed `ranging` contract. Each command is a public
method and events are `RangingEvent` cases. Discovery tokens cross as `Data`; no `NISession`,
