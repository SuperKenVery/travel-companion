...
public enum NotificationsEvent: Sendable, Equatable {
    case authorizationChanged(status: NotificationAuthorization)
...
public typealias NotificationsEventSink = @MainActor @Sendable (NotificationsEvent) -> Void

/// Platform capability values exposed without leaking UserNotifications objects.
public struct NotificationsCapabilitySnapshot: Sendable, Equatable {
...
@MainActor
public final class NotificationsAppleBackend: NSObject {
    public nonisolated static var capabilitySnapshot: NotificationsCapabilitySnapshot {
        NotificationsCapabilitySnapshot(
    ...
    private let eventSink: NotificationsEventSink
    ...
    public init(eventSink: @escaping NotificationsEventSink) {
    ...
    private func emit(_ event: NotificationsEvent) {
        eventSink(event)
    }
...
extension NotificationsAppleBackend: UNUserNotificationCenterDelegate {
