...
and `cancel` methods and emits `NotificationsEvent` values through its event sink;
`NotificationAuthorization` represents the platform authorization state. Semantic identifiers
