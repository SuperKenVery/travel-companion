...
Core Bluetooth packet backend for `tc-bluetooth`. It owns central/peripheral roles, the fixed
...
ACK correlation live in the Rust `BluetoothRuntime`/`tc-protocol`. Swift therefore does not know
